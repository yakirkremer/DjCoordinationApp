...
const he = {
  ...
  admin: {
    ...
    dropTypesHint: "רשימה זו משמשת לבחירת גרסה בעת העלאה ועריכה. לכל שיר ניתן להעלות גרסה אחת לכל סוג דרופ.",
...
const en = {
  ...
  admin: {
    ...
    dropTypesHint: "Used when uploading or editing versions. Each track can have one version per drop type.",
