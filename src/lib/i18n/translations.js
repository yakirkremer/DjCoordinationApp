...
const he = {
  ...
  admin: {
    ...
    deleteClientConfirm:
      'למחוק את הלקוח "{name}"?\n\nיימחקו גם ההעדפות, החוזה והנתונים שלו מהמערכת.',
    deleteTemplateConfirm: 'למחוק את תבנית החוזה "{name}"?',
...
const en = {
  ...
  admin: {
    ...
    deleteClientConfirm:
      'Delete client "{name}"?\n\nTheir preferences, contract, and feedback data will also be removed.',
    deleteTemplateConfirm: 'Delete contract template "{name}"?',
