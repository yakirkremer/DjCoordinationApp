...
const he = {
  ...
  home: {
    ...
    startHint: "מלאו את טופס ההעדפות וגלשו בקטלוג — אפשר לעבוד במקביל",
    ...
    privacyNote: "רק הדיג'יי שלכם רואה את התשובות — לא משתפים עם אורחים.",
    autoSaveNote: "השינויים נשמרים אוטומטית.",
    eventDate: "תאריך האירוע",
    progressSummary: "השלמתם {percent}% מהטופס · {favorites} מועדפים",
    progressSummaryFormOnly: "השלמתם {percent}% מהטופס",
    ...
    actionGuideDesc: "מה ההבדל בין דרופים וסגנונות",
    actionTutorialTitle: "איך זה עובד",
    actionTutorialDesc: "סיור קצר במערכת",
    contractPendingTitle: "יש חוזה הממתין לחתימתכם",
    contractPendingDesc: "אנא קראו וחתמו על החוזה לפני האירוע",
    contractSignAction: "חתמו על החוזה",
    contractViewAction: "פתחו את החוזה",
    contractSignedTitle: "החוזה נחתם",
    contractSignedDesc: "ניתן לצפות בחוזה החתום",
    contractNotSentDesc: "הדיג'יי ישלח אליכם חוזה לחתימה בקרוב",
    contractProfileMissingTitle: "חסרים פרטי אירוע",
    contractProfileMissingDesc:
      "לפני החתימה, מלאו שם, תאריך ומיקום האירוע — הם ימולאו אוטומטית בשדות החוזה.",
    ...
    actionContractViewTitle: "צפייה בחוזה",
    actionContractViewDesc: "החוזה נחתם — לחצו לצפייה",
    overviewTitle: "סיכום ההעדפות שלכם",
  ...
  wizard: {
    ...
    answeredHint: "{answered} מתוך {total} נענו בשלב זה",
    alreadyCompleted: "הטופס כבר הושלם — השינויים נשמרים אוטומטית",
    browseCatalog: "גלוש בקטלוג",
    summaryFinish: "סיום והמשך לדירוג שירים",
  ...
  browse: {
    ...
    hideRated: "הסתר שירים שדירגתי",
    showAll: "הצג הכל",
    phaseGroupOther: "סגנונות נוספים",
    ratedProgress: "{rated} מתוך {total} שירים דורגו",
    emptyCatalogTitle: "עדיין אין שירים כאן",
    emptyCatalogBody: "בקשו מהדיג'יי להעלות קטלוג — ואז תוכלו לדרג ולבחור מועדפים.",
  ...
  toast: {
    resumeWizard: "ברוכים השבים — אפשר להמשיך את הטופס או לגלוש בשירים",
    resumeBrowse: "ברוכים השבים — ההעדפות שלכם מחכות",
  },
  errors: {
    catalogLoadTitle: "לא הצלחנו לטעון את הקטלוג",
    catalogLoadBody: "נסו לרענן את הדף. אם זה נמשך, פנו לדיג'יי.",
    catalogLoadAction: "רענון",
    boundaryTitle: "משהו השתבש",
    boundaryBody: "לא הצלחנו להציג את החלק הזה. נסו שוב או רעננו את הדף.",
...
const en = {
  ...
  welcome: {
    ...
    backToClient: "Back to client area",
  ...
  home: {
    ...
    startHint: "Fill in the preferences form and browse the catalog — you can do both in any order",
    ...
    privacyNote: "Only your DJ can see your responses — not shared with guests.",
    autoSaveNote: "Your changes are saved automatically.",
    eventDate: "Event date",
    progressSummary: "You completed {percent}% · {favorites} favorites",
    progressSummaryFormOnly: "You completed {percent}% of the form",
    ...
    actionGuideDesc: "Understand drops & music styles",
    actionTutorialTitle: "How it works",
    actionTutorialDesc: "Quick tour of the app",
    contractPendingTitle: "A contract is waiting for your signature",
    contractPendingDesc: "Please read and sign the contract before your event",
    contractSignAction: "Sign contract",
    contractViewAction: "Open contract",
    contractSignedTitle: "Contract signed",
    contractSignedDesc: "You can view your signed contract",
    contractNotSentDesc: "Your DJ will send you a contract to sign soon",
    contractProfileMissingTitle: "Event details missing",
    contractProfileMissingDesc:
      "Before signing, fill in your name, event date, and location — they will auto-fill on the contract.",
    ...
    actionContractViewDesc: "Contract signed — tap to view",
    overviewTitle: "Your preferences summary",
  ...
  wizard: {
    ...
    privacyNote: "Only your DJ can see your responses.",
    answeredHint: "{answered} of {total} answered on this step",
    alreadyCompleted: "Form already completed — your changes save automatically",
    browseCatalog: "Browse catalog",
    summaryFinish: "Finish & rate tracks",
    summaryDone: "Save & return to dashboard",
    stepType: {
      default: "Form step",
  ...
  browse: {
    ...
    hideRated: "Hide already rated",
    showAll: "Show all",
    phaseGroupOther: "More styles",
    ratedProgress: "{rated} of {total} tracks rated",
    emptyCatalogTitle: "No songs here yet",
    emptyCatalogBody: "Ask your DJ to upload tracks — then you can rate and pick favorites.",
  ...
  rating: {
    groupLabel: "Track rating",
    love: "Love",
    maybe: "Maybe",
    no: "No",
  },
  toast: {
    resumeWizard: "Welcome back — continue the form or browse tracks",
    resumeBrowse: "Welcome back — your preferences are waiting",
  },
  errors: {
    catalogLoadTitle: "Couldn't load the catalog",
    catalogLoadBody: "Try refreshing the page. If it keeps happening, contact your DJ.",
    catalogLoadAction: "Refresh",
    boundaryTitle: "Something went wrong",
    boundaryBody: "This section failed to load. Try again or refresh the page.",
    boundaryAction: "Try again",
    boundaryRefresh: "Refresh page",
  },
  admin: {
    tabs: {
      catalog: "CATALOG",
